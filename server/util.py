...
if __name__=='__main__':
    ...
    print('1st image \n')
    print(classify_image(None, "server/test_images/maria_1.jpg"))
    print('2nd image \n')
    print(classify_image(None, "server/test_images/maria_2.jpg"))
    print('3rd image \n')
    print(classify_image(None, "server/test_images/maria_3.jpg"))
    print('4th image \n')
    print(classify_image(None, "server/test_images/messi_1.jpg"))
    print(classify_image(None, "server/test_images/messi_2.jpg"))
    print(classify_image(None, "server/test_images/messi_3.jpg"))
